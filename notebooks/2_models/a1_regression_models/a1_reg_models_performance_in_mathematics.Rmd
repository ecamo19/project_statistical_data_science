---
title: 'Regression models for students performance in Mathematics (A1)'
...
knitr::opts_chunk$set(autodep        = TRUE,
                      ...
                      fig.path       = paste0("../a1_regression_models/regression_models_figures/", "/"),
                      fig.width      = 20,
                      fig.height     = 15,
                      message        = FALSE,
                      warning        = FALSE)
...
best_lambda_ridge_train <- ridge_math_train$lambda.1se
...
table_4 <- autofit(table_4)

save_as_image(x = table_4, path = "../a1_regression_models/regression_models_figures/table_4.png")
```
