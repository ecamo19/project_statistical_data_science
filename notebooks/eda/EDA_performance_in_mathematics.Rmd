...
+ school, pstatus, failures, schoolsup, higher
...
+ The data set has a total of 395 observation and 31 variables. 18 of these I consider are better if are treated as factors. G1, G2, G3, Age and Absences are treated as numeric and med, fedu, famrel free_time, go out, walc, dalc, health, travel time and study time are treated as integers.  
