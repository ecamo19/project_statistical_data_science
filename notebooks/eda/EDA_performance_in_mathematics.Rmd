...
#tf <- tempfile(fileext = ".png")
save_as_image(x = table_1, path = "../eda/eda_figures/table_1.png")
```
# Table 2
```{r}
(table_2 <- 
...
#tf <- tempfile(fileext = ".png")
save_as_image(x = table_2, path = "../eda/eda_figures/table_2.png")
```
...
#  Table 3
Variable prepossessing. Removing predictors
